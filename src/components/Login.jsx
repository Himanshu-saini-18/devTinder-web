...
const Login = () => {
  const [emailId, setEmailId] = useState("akshay@gmail.in");
        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-12 lg:flex-row lg:items-center lg:justify-between">
          <div className="max-w-2xl space-y-6">
            ...
            <p className="max-w-xl text-lg leading-8 text-slate-300">
              Sign in to explore curated profiles, connect instantly, and
              discover meaningful conversations with people who share your vibe.
            </p>
            ...
            <div className="rounded-[2rem] border border-white/10 bg-white/10 p-8 shadow-2xl shadow-violet-500/20 backdrop-blur-xl ring-1 ring-white/10">
              <div className="mb-8 space-y-2 text-center">
                <h2 className="text-3xl font-semibold text-white">
                  {isLoginForm ? "Log in to continue" : "SignUP"}
                </h2>
                <p className="text-sm text-slate-300">
                  Enter your account details and get back to your connections.
                </p>
              </div>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {error && (
                  <p className="rounded-2xl bg-rose-500/15 px-4 py-3 text-sm text-rose-200 ring-1 ring-rose-500/20">
                    {error}
                  </p>
                )}
                <button
              ...
              <p
                className="font-medium text-violet-200 hover:text-white cursor-pointer mx-20 my-5"
